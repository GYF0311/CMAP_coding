...
| freshness | `pnpm test tests/integration/m18-freshness-inbox-promote.test.ts` and `pnpm test tests/integration/m30-freshness-lock.test.ts` | Freshness snapshots, semantic review markers, generated/canonical UX, locked atomic writes, generated evidence drift, low-risk inbox promote apply, and explicit reject archive are covered. |
