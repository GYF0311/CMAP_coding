...
## Purpose
Implement cmap v0.2 Trust Boundary + Human Review Layer: a host-neutral, repo-local project map CLI for humans and AI coding agents. It maintains deterministic `.context/` structure, candidate governance, safety boundaries, and an English HTML review surface so AI coding projects remain resumable after context compression, new sessions, and module growth.
