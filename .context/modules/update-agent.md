...
- Share the candidate-store schema with other producers such as route, reconcile, and Obsidian pull; update-agent itself only produces MapPatch-derived candidates.
