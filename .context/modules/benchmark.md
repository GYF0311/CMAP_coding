...
## Purpose
Measure whether deterministic cmap routing and route context packs match explicit JSONL fixtures without treating benchmark evidence as canonical project truth.
...
## State / Storage
Read-only for canonical project memory. Benchmark fixtures live under `bench/`.
