...
- Source-level facts such as imports, callers/callees, symbol lookup, and impact analysis belong to the configured code intelligence tool, such as CodeGraph.
- CMAP records durable project memory: module explanations, handoff, decisions, status, candidates, and verification notes.
